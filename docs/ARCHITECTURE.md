...
This document describes current and intended boundaries. Phases 1-17 provide the scaffold through accepted official-resource terrain rendering and basic local movement/collision. Phase 17B owns comprehensive vanilla block collision-shape fidelity and sneak-edge prevention; entities, interaction, and later environment systems remain unimplemented.
