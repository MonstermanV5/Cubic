...
This document describes current and intended boundaries. Phases 1-15 provide the scaffold through diagnostic terrain rendering. Phase 16 adds a bounded official vanilla block-resource/model path; gameplay, movement, entities, and later environment systems remain unimplemented.
