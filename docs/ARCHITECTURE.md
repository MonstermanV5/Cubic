...
This document describes current and intended boundaries. Phases 1-18C provide the scaffold through accepted official-resource terrain rendering, movement, vanilla block-collision fidelity, rendering fidelity, special movement, and seamless Play/Chat presentation; entities and interaction remain unimplemented.
