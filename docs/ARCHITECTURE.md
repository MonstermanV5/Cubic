...
This document describes current and intended boundaries. Phases 1-7 provide the scaffold, graphics bootstrap, protocol/NBT foundations, Status, version data, and the validated development login. Phase 8 adds the accepted persistent offline Chat Mode, and Phase 9 adds the accepted provider-neutral authenticated/secure-chat foundation whose first reference profile is Java 26.1.2 / protocol 775. Minecraft game systems and world rendering remain unimplemented.
